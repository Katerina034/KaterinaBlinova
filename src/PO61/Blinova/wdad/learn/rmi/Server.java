...

{
    ...
    public static void main(String[] args) throws IOException, SAXException, ParserConfigurationException, URISyntaxException {
        ...
        String port = preferencesManager.getProperty(PreferencesManagerConstsnts.REGISTRY_PORT);
        ...
        createRegistry = preferencesManager.getProperty(PreferencesManagerConstsnts.CREATE_REGISTRY);
        ...
        try{
            ...
            if(preferencesManager.getProperty(PreferencesManagerConstsnts.CREATE_REGISTRY).equals("yes"))
